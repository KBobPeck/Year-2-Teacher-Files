//Part 1 find the index of the number 2021 --- ans:185
...
for (let i = 0; i < input.length; i++) {
  if (input[i] === 2021) console.log(i);
}

for (num in input) {
  if (input[num] === 2021) console.log(num);
}

input.map((num, index) => {
  if (num === 2021) console.log(index);
});

input.indexOf(2021);

//part 2 only 2 number will add together to get 2021
//find the product of those 2 numbers
//e.g.  1000 + 1021  outpur: 1000 * 1021
